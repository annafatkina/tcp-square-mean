...
class Logger : public std::enable_shared_from_this<Logger> {
    ...
    // Process log messages queue. Print them into output and save to the dump
    // queue.
    ...
    // Cast the specified 'args' to strings and concatenate them. Return the
    // concatenated string.
...
template <typename T> std::string Logger::toString(T value) {
...
template <typename... Types> void Logger::print(Types... args) {
